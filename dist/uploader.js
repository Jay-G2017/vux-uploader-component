(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vux-uploader-component"] = factory();
	else
		root["vux-uploader-component"] = factory();
...
var _previewer = __webpack_require__(85);
...
exports.default = {
  ...
  props: {
    ...
    limitPrompt: {
      type: Function,
      default: function _default(limit) {
        return '\u4E0D\u80FD\u4E0A\u4F20\u8D85\u8FC7' + limit + '\u5F20\u56FE\u7247';
      }
    },
    capture: {
      type: Boolean | String,
  ...
  methods: {
    change: function change(e) {
      ...
      return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        var enableCompress, maxWidth, quality, limit, limitPrompt, fileList, autoUpload, uploadFile, target, inputChangeFiles;
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                enableCompress = _this.enableCompress, maxWidth = _this.maxWidth, quality = _this.quality, limit = _this.limit, limitPrompt = _this.limitPrompt, fileList = _this.fileList, autoUpload = _this.autoUpload, uploadFile = _this.uploadFile;
                target = e.target || e.srcElement;
                inputChangeFiles = target.files;
              ...
              case 7:
                _promise2.default.all(Array.prototype.map.call(inputChangeFiles, function (file) {
                  var doSquash = file.type === 'image/jpeg';
                  return (0, _utils.handleFile)(file, {
                    maxWidth: maxWidth,
                    quality: quality,
                    enableCompress: enableCompress
                  }, doSquash).then(function (blob) {
                    ...
                    if (autoUpload) {
                      uploadFile(blob, fileItem).then(function (result) {
                        fileList.push(fileItem);
                        _this.$emit('on-change', fileItem, fileList);
                      }).catch(function (e) {
                        fileList.push(fileItem);
                      });
                    } else {
    ...
    handleFileClick: function handleFileClick(e, item, index) {
      this.$refs.previewer.show(index);
      this.previewerIndex = index;
    },
    deleteImg: function deleteImg(currentIndex) {
      var _this2 = this;

      var fileList = this.fileList;

      var delFn = function delFn() {
        var deleteItem = fileList[currentIndex];
        fileList.splice(currentIndex, 1);
        _this2.$nextTick(function () {
          _this2.$emit('on-change', deleteItem, fileList);
          _this2.$refs.previewer.close();
        });
      };
    ...
    uploadFile: function uploadFile(blob, fileItem) {
      var _this3 = this;
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        xhr.upload.addEventListener('progress', function (evt) {
          if (evt.lengthComputable) {
            var precent = Math.ceil(evt.loaded / evt.total * 100);
        ...
        for (var _key in headers) {
          if (headers.hasOwnProperty(_key) && headers[_key] !== null) {
...
var _photoswipe = __webpack_require__(102);

var _photoswipe2 = _interopRequireDefault(_photoswipe);

var _photoswipeUiDefault = __webpack_require__(103);
...
var _uploader = __webpack_require__(45);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_uploader_vue__ = __webpack_require__(27);
...
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_uploader_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_uploader_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c6f3fc8c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_uploader_vue__ = __webpack_require__(107);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c6f3fc8c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_uploader_vue__["a" /* default */],
...
var update = __webpack_require__(10)("c42fc2ac", content, true, {});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_previewer_vue__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_previewer_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_previewer_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_previewer_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_previewer_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_761e2d9c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_previewer_vue__ = __webpack_require__(104);
function injectStyle (ssrContext) {
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_previewer_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_761e2d9c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_previewer_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(10)("6c6c673a", content, true, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(10)("2b23e962", content, true, {});
...
module.exports = __webpack_require__.p + "default-skin.png?e3f799c6dec9af194c86decdf7392405";

/***/ }),
/* 92 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "default-skin.svg?b257fa9c5ac8c515ac4d77a667ce2943";

/***/ }),
/* 93 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "preloader.gif?e34aafbb485a96eaf2a789b2bf3af6fe";
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(10)("41d25caa", content, true, {});
...
// module
exports.push([module.i, ".vux-uploader_del{position:absolute;right:0;bottom:0;left:0;background-color:#0d0d0d;color:#fff;height:60px;line-height:60px;text-align:center;font-family:weui}.vux-uploader_del:after{color:#fff;font-size:22px;content:\"\\EA11\"}", ""]);
...
exports.detectImageAutoRotate = exports.handleFile = exports.dataURItoBlob = exports.transformCoordinate = exports.detectSubsampling = exports.detectVerticalSquash = undefined;

var _promise = __webpack_require__(16);

var _promise2 = _interopRequireDefault(_promise);

var _exifJs = __webpack_require__(106);
  ...
  return new _promise2.default(function (resolve, reject) {
    ...
    image.onload = function () {
      ...
      _exifJs2.default.getData(image, function () {
        ...
        var vertSquashRatio = doSquash ? detectVerticalSquash(image) : 1;
        var dw = enableCompress ? Math.min(Number(maxWidth), w) : w;
        var dh = h * (dw / w) / vertSquashRatio;
        detectImageAutoRotate().then(function (isImageAutoRotate) {
...
exports.detectSubsampling = detectSubsampling;
exports.transformCoordinate = transformCoordinate;
exports.dataURItoBlob = dataURItoBlob;
exports.handleFile = handleFile;
exports.detectImageAutoRotate = detectImageAutoRotate;
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vux-uploader"},[_c('div',{staticClass:"vux-uploader_hd"},[_c('p',{staticClass:"vux-uploader_title"},[_vm._v(_vm._s(_vm.title))]),_vm._v(" "),_c('div',{staticClass:"vux-uploader_info"},[_vm._v(_vm._s(_vm.fileList.length)+" / "+_vm._s(_vm.limit))])]),_vm._v(" "),_c('div',{staticClass:"vux-uploader_bd"},[_c('ul',{staticClass:"vux-uploader_files"},_vm._l((_vm.fileList),function(item,index){return _c('li',{key:index,class:{
            'vux-uploader_file': true,
            'vux-uploader_file-status': !!item.fetchStatus && item.fetchStatus !== 'success'
          },style:({
            backgroundImage: ("url(" + (item.url) + ")")
          }),on:{"click":function($event){return _vm.handleFileClick($event, item, index)}}},[(!!item.fetchStatus && item.fetchStatus !== 'success')?_c('div',{staticClass:"vux-uploader_file-content"},[_vm._v("\n          "+_vm._s(item.fetchStatus === 'progress' ? item.progress + '%' : '')+"\n          "),_vm._v(" "),(item.fetchStatus === 'fail')?_c('i',{staticClass:"upload-error"}):_vm._e()]):_vm._e()])}),0),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.fileList.length < _vm.limit && !_vm.readonly),expression:"fileList.length < limit && !readonly"}],staticClass:"vux-uploader_input-box"},[_c('input',{ref:"input",staticClass:"vux-uploader_input",attrs:{"type":"file","name":"uploadInput","accept":"image/*","capture":_vm.capture,"multiple":_vm.multiple},on:{"change":_vm.change}})])]),_vm._v(" "),_c('priviewer',{ref:"previewer",attrs:{"list":_vm._f("filterList")(_vm.fileList),"readonly":_vm.readonly},on:{"on-delete":_vm.deleteImg}})],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
